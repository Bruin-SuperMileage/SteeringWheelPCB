...
void setup() {
 ...
 // INPUT FUNCTION// 
  ...
  pinMode(LEFT_TURN_SWTICH, INPUT);
  pinMode(RIGHT_TURN_SWTICH, INPUT);
  pinMode(HAZARD_SWITCH, INPUT);
  pinMode(BRAKE_SWTICH, INPUT);
  pinMode(HORN_SWTICH, INPUT);
  pinMode(WIPER_SWTICH, INPUT);
